...
export enum EActionTypes {
  GET_EVENTS_TOP_AGENT_SUCCESS = "[SECURITY]_GET_EVENTS_TOP_AGENT_SUCCESS"
}
...
export class Get implements IMiddlewareAction {
  ...
  constructor(payload?: any, next?: (res) => void, nextError?: () => void) {
    this.payload = {
      url: `/Dashboard/GetTop5SecurityEvent`,
      method: "POST",
      data: payload,
      successType: EActionTypes.GET_EVENTS_TOP_AGENT_SUCCESS,
      afterSuccess: next,
